...
As mentioned in [disclaimer](/others/disclaimer) page, the model I used to detect handsigns is a publically available model and is created by [Kazuhito](https://github.com/Kazuhito00) san.
